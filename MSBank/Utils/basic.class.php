 ...
 * @return boolean
 */
function img2pngthumbByBin($src_bin, $width = 144, $height = 144, $cut = 0, $proportion = 0)
{
    if (! strlen($src_bin)) {
        return false;
    }
    $srcinfo = getimagesizefromstring($src_bin);
            ...
            if (! $dst_w) // 裁剪时无宽
{
    ...
    $src = imagecreatefromstring($src_bin);
    ...
    ob_start();
    $dst_bin = imagepng($dst, null, 9, PNG_NO_FILTER);
...
// $src_bin = file_get_contents('C:\\Users\\Administrator\\Desktop\\IMG_0296.JPG');

// $dst_bin = img2pngthumbByBin($src_bin);

// echo strlen($dst_bin), PHP_EOL;
// file_put_contents('C:\\Users\\Administrator\\Desktop\\1111.png', $dst_bin);
// echo "==========================";